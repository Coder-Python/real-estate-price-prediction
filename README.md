...
This part was quite challenging, and after many trial and error, i realised that sklearn was needed for xgboost to work, so sklearn was added to the deployment/requirements.txt file.

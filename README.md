...
This part with Docker and render was quite challenging, and after many trial and error and thus so much time wasted, i also realised that sklearn was needed for xgboost to work, so sklearn was added to the deployment/requirements.txt file.
